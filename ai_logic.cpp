    ...
    for(int i = 0; i < movesNum; ++i){
        ...
        if(score > alpha){
            ...
            if(score >= beta){
                ...
                addMoveTT(newMove, depth, beta, 2, zobrist);
...
*/
    ...
    addMoveTT(bestMove, depth, alpha, hashFlag, zobrist);
...
void Ai_Logic::addMoveTT(Move move, int depth, long eval, int flag, ZobristH *zobrist)
{
